...
VALUES (1, 'Event that can happen during the execution of a program and disrupts it´s normal flow', 'true', 1),
       ...
       (94, 'SQL is a standard query language used for maintaining the non-relational database', 'false', 24),
       (95, 'SQL is a javascript language used for maintaining the non-relational database', 'false', 24),
